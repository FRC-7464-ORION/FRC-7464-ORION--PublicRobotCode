/** ===========================================================================
 * @file   CmdEnableSmoothingMode.h
 * @brief  This file declares the CmdEnableSmoothingMode class.
 *
...
// If we have not already defined CMDENABLESMOOTHINGMODE_H...
#ifndef CMDENABLESMOOTHINGMODE_H
// Define CMDENABLESMOOTHINGMODE_H
#define CMDENABLESMOOTHINGMODE_H
...
/** ****************************************************************************
 * @class   CmdEnableSmoothingMode
 * @brief   This is a class that defines a command used in enabling the
 *            smoothing mode on the drive train.
 * @author  FRC Team #7464 - ORION
 ******************************************************************************/
class CmdEnableSmoothingMode
  : public frc2::CommandHelper<frc2::CommandBase, CmdEnableSmoothingMode> {
  ...
  public:
    ...
    /** 
     * The CmdEnableSmoothingMode class constructor.
     * 
     * @param subsystem            The subsystem used by this command
     */
    explicit CmdEnableSmoothingMode(SubSysDriveTrain* subsystem);

    /** The CmdEnableSmoothingMode class destructor. */
    ~CmdEnableSmoothingMode();
...
}; // end class CmdEnableSmoothingMode

#endif // #ifndef CMDENABLESMOOTHINGMODE_H
