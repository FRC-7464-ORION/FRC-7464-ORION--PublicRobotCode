/** ===========================================================================
 * @file   CmdDriveTankStyle.h
 * @brief  This file declares the CmdDriveTankStyle class.
 *
 * The CmdDriveTankStyle class is used to allow the robot to be drive using
 * a differential drive in tank mode.
 *
 * COPYRIGHT NOTICES:
 *
 * Some portions:
...
// If we have not already defined CMDDRIVETANKSTYLE_H...
#ifndef CMDDRIVETANKSTYLE_H
// Define CMDDRIVETANKSTYLE_H
#define CMDDRIVETANKSTYLE_H
...
/** ****************************************************************************
 * @class   CmdDriveTankStyle
 * @brief   This is a class that defines a command used in driving the
 *            robot using tank drive.
 * @author  FRC Team #7464 - ORION
 ******************************************************************************/
class CmdDriveTankStyle
  : public frc2::CommandHelper<frc2::CommandBase, CmdDriveTankStyle> {
  ...
  public:
    ...
    /** 
     * The CmdDriveTankStyle class constructor.
     * 
     * @param subsystem The subsystem used by this command
     * @param joystick  The joystick used by this command
     */
    explicit CmdDriveTankStyle(SubSysDriveTrain* subsystem,
                                 frc::Joystick* joystick);

    /** The CmdDriveTankStyle class destructor. */
    ~CmdDriveTankStyle();
...
}; // end class CmdDriveTankStyle 

#endif // #ifndef CMDDRIVETANKSTYLE_H
