 ...
 ******************************************************************************/
class CmdEnableTurboMode
  : public frc2::CommandHelper<frc2::CommandBase, CmdEnableTurboMode> {
  ...
  public:
    ...
    /** 
     * The CmdEnableTurboMode class constructor.
     * 
     * @param subsystem            The subsystem used by this command
     */
    explicit CmdEnableTurboMode(SubSysDriveTrain* subsystem);
