/** ===========================================================================
 * @file   CmdResetAHRSYaw.h
 * @brief  This file declares the CmdResetAHRSYaw class.
 *
 * The CmdZeroAHRSYaw class is used to manually reset the yaw on the AHRS of
 * the NavX MXP IMU.
 *
 * COPYRIGHT NOTICES:
 *
...
// If we have not already defined CMDRESETAHRSYAW_H...
#ifndef CMDRESETAHRSYAW_H
// Define CMDRESETAHRSYAW_H
#define CMDRESETAHRSYAW_H
 ...
 * @brief   This is a class that defines a command used in resetting the yaw of 
