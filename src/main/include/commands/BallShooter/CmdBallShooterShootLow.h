/** ===========================================================================
 * @file   CmdBallShooterShootLow.h
 * @brief  This file declares the CmdBallShooterShootLow class.
 *
 * The CmdBallShooterShootLow class is used to command the ball shooter to 
 * shoot balls to the low target.
 *
 * COPYRIGHT NOTICES:
 *
 * Some portions:
...
// If we have not already defined CMDBALLSHOOTERSHOOTLOW_H...
#ifndef CMDBALLSHOOTERSHOOTLOW_H
// Define CMDBALLSHOOTERSHOOTLOW_H
#define CMDBALLSHOOTERSHOOTLOW_H
...
/** ****************************************************************************
 * @class   CmdBallShooterShootLow
 * @brief   This is a class that defines a command used to have the ball shooter
 *            subsytem shoot balls to the low target
 * @author  FRC Team #7464 - ORION
 ******************************************************************************/
class CmdBallShooterShootLow
  : public frc2::CommandHelper<frc2::CommandBase, CmdBallShooterShootLow> {
  ...
  public:
    ...
    /** 
     * The CmdBallShooterShootLow class constructor.
     * 
     * @param subsystem The subsystem used by this command
     */
    explicit CmdBallShooterShootLow(SubSysBallShooter* subsystem);

    /** The CmdBallShooterShootLow class destructor. */
    ~CmdBallShooterShootLow();
...
}; // end class CmdBallShooterShootLow

#endif // #ifndef CMDBALLSHOOTERSHOOTLOW_H
