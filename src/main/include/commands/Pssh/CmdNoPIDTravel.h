/** ===========================================================================
 * @file   CmdNoPIDTravel.h
 * @brief  This file declares the CmdNoPIDTravel class.
 *
...
// If we have not already defined CMDNOPIDTRAVEL_H...
#ifndef CMDNOPIDTRAVEL_H
// Define CMDNOPIDTRAVEL_H
#define CMDNOPIDTRAVEL_H
...
/** ****************************************************************************
 * @class   CmdNoPIDTravel
 * @brief   This is a class that defines a command used in setting the power
 *          cell collector to the travel position.
 * @author  FRC Team #7464 - ORION
 ******************************************************************************/
class CmdNoPIDTravel : public frc::Command {

  public:

    /** The CmdNoPIDTravel class default constructor. */
    CmdNoPIDTravel();

    /** The CmdNoPIDTravel class destructor. */
    ~CmdNoPIDTravel();
...
}; // end class CmdNoPIDTravel

#endif // #if !USE_PID_PSSH

#endif // #ifndef CMDNOPIDTRAVEL_H
