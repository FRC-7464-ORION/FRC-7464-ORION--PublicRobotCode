/** ===========================================================================
 * @file   CmdNoPIDDump.h
 * @brief  This file declares the CmdNoPIDDump class.
 *
...
// If we have not already defined CMDNOPIDDUMP_H...
#ifndef CMDNOPIDDUMP_H
// Define CMDNOPIDDUMP_H
#define CMDNOPIDDUMP_H
 ...
 ******************************************************************************/
class CmdNoPIDDump : public frc::Command {

  public:

    /** The CmdNoPIDDump class default constructor. */
    CmdNoPIDDump();

    /** The CmdNoPIDDump class destructor. */
    ~CmdNoPIDDump();
...
}; // end class CmdNoPIDDump

#endif // #if !USE_PID_PSSH

#endif // #ifndef CMDNOPIDDUMP_H
