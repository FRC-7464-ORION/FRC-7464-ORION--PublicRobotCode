/** ===========================================================================
 * @file   PIDCmdGrabHatchPanel.h
 * @brief  This file declares the PIDCmdGrabHatchPanel class.
 *
...
// If we have not already defined PIDCMDGRABHATCHPANEL_H...
#ifndef PIDCMDGRABHATCHPANEL_H
// Define PIDCMDGRABHATCHPANEL_H
#define PIDCMDGRABHATCHPANEL_H
...
/** ****************************************************************************
 * @class   PIDCmdGrabHatchPanel
 * @brief   This is a class that defines a command used in grabbing a hatch
 *            panel from the loading station, using a PID controller.
 * @author  FRC Team #7464 - ORION
 ******************************************************************************/
class PIDCmdGrabHatchPanel : public frc::Command {

  public:

    /** The PIDCmdGrabHatchPanel class default constructor. */
    PIDCmdGrabHatchPanel();

    /** The PIDCmdGrabHatchPanel class destructor. */
    ~PIDCmdGrabHatchPanel();
...
}; // end class PIDCmdGrabHatchPanel

#endif // #if USE_PID_CAPT_HOOK

#endif // #ifndef PIDCMDGRABHATCHPANEL_H
