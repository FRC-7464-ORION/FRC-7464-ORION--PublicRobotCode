/** ===========================================================================
 * @file   CmdClimbForward.h
 * @brief  This file declares the CmdClimbForward class.
 *
...
// If we have not already defined CMDCLIMBFORWARD_H...
#ifndef CMDCLIMBFORWARD_H
// Define CMDCLIMBFORWARD_H
#define CMDCLIMBFORWARD_H
...
/** ****************************************************************************
 * @class   CmdClimbForward
 * @brief   This is a class that defines a command used in allowing the robot
 *            to climb forwards.
 * @author  FRC Team #7464 - ORION
 ******************************************************************************/
class CmdClimbForward : public frc::Command {

  public:

     /** The CmdClimbForward class default constructor. */
     CmdClimbForward();

     /** The CmdClimbForward class destructor. */
     ~CmdClimbForward();
...
}; // end class CmdClimbForward

#endif // #if USE_TIPPY_TOES

#endif // #ifndef CMDCLIMBFORWARD_H
