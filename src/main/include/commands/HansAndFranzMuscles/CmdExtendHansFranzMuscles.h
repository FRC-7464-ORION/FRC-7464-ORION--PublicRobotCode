/** ===========================================================================
 * @file   CmdExtendHansFranzMuscles.h
 * @brief  This file declares the CmdExtendHansFranzMuscles class.
 *
...
// If we have not already defined CMDEXTENDHANSFRANZMUSCLES_H...
#ifndef CMDEXTENDHANSFRANZMUSCLES_H
// Define CMDEXTENDHANSFRANZMUSCLES_H
#define CMDEXTENDHANSFRANZMUSCLES_H
...
/** ****************************************************************************
 * @class   CmdExtendHansFranzMuscles
 * @brief   This is a class that is used in moving Hans and Franz cylinders to
 *          the extended position.
 * @author  FRC Team #7464 - ORION
 ******************************************************************************/
class CmdExtendHansFranzMuscles
  : public frc2::CommandHelper<frc2::CommandBase, CmdExtendHansFranzMuscles> {
  ...
  public:
    ...
    /** 
     * The CmdExtendHansFranzMuscles class constructor.
     * 
     * @param subsystem The subsystem used by this command
     */
    explicit CmdExtendHansFranzMuscles(SubSysHansFranzMuscles* subsystem);

    /** The CmdExtendHansFranzMuscles class destructor. */
...
}; // end class CmdExtendHansFranzMuscles

#endif // #ifndef CMDEXTENDHANSFRANZMUSCLES_H
