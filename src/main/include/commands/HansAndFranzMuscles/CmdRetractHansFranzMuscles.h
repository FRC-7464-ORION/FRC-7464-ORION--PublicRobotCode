 ...
 ******************************************************************************/
class CmdRetractHansFranzMuscles
  : public frc2::CommandHelper<frc2::CommandBase, CmdRetractHansFranzMuscles> {
  ...
  public:
    ...
    /** 
     * The CmdRetractHansFranzMuscles class constructor.
     * 
     * @param subsystem The subsystem used by this command
    */
    explicit CmdRetractHansFranzMuscles(SubSysHansFranzMuscles* subsystem);
