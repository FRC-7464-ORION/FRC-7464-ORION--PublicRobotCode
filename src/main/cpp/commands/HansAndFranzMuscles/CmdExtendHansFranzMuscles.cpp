...
// The default constructor for the CmdExtendHansFranzMuscles class
...
void CmdExtendHansFranzMuscles::Execute() {
  ...
  Robot::m_subSysHansFranzMuscles->ExtendHansFranzMuscles();
...
void CmdExtendHansFranzMuscles::End() {


} // end CmdExtendHansFranzMuscles::End()

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void CmdExtendHansFranzMuscles::Interrupted() {


} // end CmdExtendHansFranzMuscles::Interrupted()
